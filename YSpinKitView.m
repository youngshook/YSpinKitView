...
@implementation YSpinKitView

-(id)initWithStyle:(YSpinKitViewStyle)style {
    return [self initWithStyle:style color:[UIColor grayColor]];
}

-(id)initWithStyle:(YSpinKitViewStyle)style color:(UIColor*)color {
    self = [super init];
    if (self) {
        _style = style;
        _color = color;
        ...
        else if (style == YSpinKitViewStyleBounce) {
        ...
        else if (style == YSpinKitViewStyleWave) {
        ...
        else if (style == YSpinKitViewStyleWanderingCubes) {
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        else if (style == YSpinKitViewStylePulse) {
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        else if (style == YSpinKitViewStyleSquareWave) {
            NSTimeInterval beginTime = CACurrentMediaTime();
            
            for (NSInteger i = 0; i < 3; i++) {
                CALayer *squareWave = [CALayer layer];
                squareWave.backgroundColor = color.CGColor;
                squareWave.cornerRadius = 4.0;
                squareWave.frame = CGRectMake( 24*i - 13, 2, 16, 16);
                ...
                [self.layer addSublayer:squareWave];
                [squareWave addAnimation:transformAnimation forKey:@"transformAnimation"];
                [squareWave addAnimation:opacityAnimation forKey:@"opacityAnimation"];
            }
        }
    }
    return self;
